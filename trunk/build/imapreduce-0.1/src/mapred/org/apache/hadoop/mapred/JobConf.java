...
public class JobConf extends Configuration {
  ...
  public void setCompressReduceOutput(boolean compress) {
	    setBoolean("mapred.compress.reduce.output", compress);
	  }
  ...
  public boolean getCompressReduceOutput() {
	    return getBoolean("mapred.compress.reduce.output", false);
	  }
  ...
  public void 
  setReduceOutputCompressorClass(Class<? extends CompressionCodec> codecClass) {
    setCompressReduceOutput(true);
    setClass("mapred.reduce.output.compression.codec", codecClass, 
             CompressionCodec.class);
  }
  ...
  public Class<? extends CompressionCodec> 
  getReduceOutputCompressorClass(Class<? extends CompressionCodec> defaultValue) {
    Class<? extends CompressionCodec> codecClass = defaultValue;
    String name = get("mapred.reduce.output.compression.codec");
    if (name != null) {
      try {
        codecClass = getClassByName(name).asSubclass(CompressionCodec.class);
      } catch (ClassNotFoundException e) {
        throw new IllegalArgumentException("new Compression codec " + name + 
                                           " was not found.", e);
      }
    }
    return codecClass;
  ...
  public Class<?> getDataKeyClass() {
		    Class<?> retv = getClass("mapred.iterative.datakey.class", null, Object.class);
	
		    return retv;
	}
	
	public void setDataKeyClass(Class<?> theClass) {
		    setClass("mapred.iterative.datakey.class", theClass, Object.class);
	}

  public Class<?> getDataValClass() {
	    Class<?> retv = getClass("mapred.iterative.dataval.class", null, Object.class);

	    return retv;
  }

  public void setDataValClass(Class<?> theClass) {
	    setClass("mapred.iterative.dataval.class", theClass, Object.class);
  }
