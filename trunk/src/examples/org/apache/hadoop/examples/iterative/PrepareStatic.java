...
public class PrepareStatic extends Configured implements Tool {

	@Override
	public int run(String[] args) throws Exception {
		
		if (args.length != 3) {
		      System.err.println("Usage: preparestatic <input M> <out> <partitions>");
		      System.exit(2);
		}
	    ...
	    job1.setJarByClass(PrepareStatic.class);
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new PrepareStatic(), args);
	    System.exit(res);	
	}
}
